...
/*
Template Name: Blog Isotope 2Col RS
*/
...
<!-- this is index.php -->
						...
						<ul class="slides">
							...
							<?php 
								...
								<?php } else { ?>
									...
									<li>
										<a href="<?php echo $link_url; ?>"><img src="<?php echo get_template_directory_uri(); ?>0" height="310" /></a>
		...
		<div class="container_wrap fullsize" id="main">		
			...
			<div id="template-blog-masonry" class="container template-blog-masonry" >
			
				<div class="content eight alpha columns">
				
					<div id="container-blog-two-col">
						...
						<div class="one_half column_container" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<span class="news-author">by <?php the_author_posts_link(); ?> on <?php the_time('F jS, Y') ?> in <?php the_category(', ') ?></span>
