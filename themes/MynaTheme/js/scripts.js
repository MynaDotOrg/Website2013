...
jQuery(document).ready(function(){
	...
	jQuery('.main_menu ul:eq(0)').mobileMenu({
	  ...
	  indentString: '&nbsp;&raquo;&nbsp;'  							//string for indenting nested items
	});
	...
	jQuery('#flickr_widget a, #top .gallery a').fancybox();	
...
jQuery(function() {
	...
	jQuery(".portfolio-image img, .flickr_images img, #top .gallery a, #top .gallery a img").css("opacity","1.0");
	jQuery(".portfolio-image img, .flickr_images img, #top .gallery a, #top .gallery a img").hover(function () {
	...
	jQuery(".widget .links li a, .menu-sidebar-container li a").css("left","0");
	jQuery(".widget .links li a, .menu-sidebar-container li a").hover(function () {
