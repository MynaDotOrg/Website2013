...
<!-- this is index.php -->
						...
						<ul class="slides">
							...
							<?php 
								...
								{ ?>
									...
									<li>
										<img src="<?php get_template_directory_uri(); ?>/lib/timthumb.php?src=<?php echo $image_url[0]; ?>&h=310&w=930&zc=1" alt="" width="930" height="310" />
		...
		<div class="container_wrap fullsize" id="main">	
			...
			<div class="container" id="portfolio">
				...
				<div class="post-entry column_container one_fourth  <?php echo $sort_classes; ?> isotope-item">
